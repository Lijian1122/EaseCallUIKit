...
public class EaseRomUtils {
    ...
    public static boolean isDomesticSpecialRom() {
        return EaseRomUtils.isMiuiRom()
                || EaseRomUtils.isHuaweiRom()
                || EaseRomUtils.isMeizuRom()
                || EaseRomUtils.is360Rom()
                || EaseRomUtils.isOppoRom()
                || EaseRomUtils.isVivoRom()
                || EaseRomUtils.isLetvRom()
                || EaseRomUtils.isZTERom()
                || EaseRomUtils.isLenovoRom()
                || EaseRomUtils.isCoolPadRom();
    }
